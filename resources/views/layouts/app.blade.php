...
<div class="app-shell">
    ...
    <aside class="sidebar" id="app-sidebar">
        <a class="brand" href="{{ route('requests.index') }}">
            ...
            <span><strong>Реклама объектлари реестри</strong><small>Farg'ona invest kompaniya</small></span>
        </a>
    ...
    <div class="content">
        <header class="topbar">
            <div class="topbar-title">
                ...
                <span class="breadcrumb">@yield('breadcrumb', 'Реклама объектлари')</span>
            </div>
